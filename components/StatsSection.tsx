...
const stats: Stat[] = [
  { value: 48, label: "Products Built for\nDaily Reliability" },
...
const StatsSection = () => {
  return (
    <section className="pt-[20px] pb-[120px] px-6 xl:px-[80px] lg:px-[40px] bg-background">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          {stats.map((stat, index) => (
            <motion.div
              ...
              className="bg-[#FAF9F5] rounded-[40px] p-10 flex flex-col justify-between w-[305px] h-[318px] relative overflow-hidden"
            >
              {/* Background number in white */}
              <div className="absolute top-8 left-8 text-[160px] font-hoves-pro font-bold text-white/40 leading-none select-none pointer-events-none">
