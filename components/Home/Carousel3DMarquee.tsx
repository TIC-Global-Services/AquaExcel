...
const Carousel3DMarquee: React.FC<RollingGalleryProps> = ({
  ...
  const cylinderWidth: number = isScreenSizeSm ? 2400 : 3400;
          ...
          >
            {IMGS.map((item, i) => {
              ...
              return (
                ...
                >
                <div className="relative h-[380px] w-[260px] sm:h-[400px] sm:w-[345px] rounded-[28px] overflow-hidden transition-transform duration-300 ease-out group-hover:scale-105">
                  <img
                    src={item.url}
                    alt={item.title}
