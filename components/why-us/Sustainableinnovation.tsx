    ...
    return (
        <ContainerLayout maxWidth='w-full'>
            <div className='xl:py-20 mb-10 py-10 flex flex-col items-center gap-20'>
                <div className=''>
                    <h1 className='text-xl lg:text-[2.75rem] font-medium tracking-tight font-hoves-pro  text-center'>Sustainable Innovation & Research</h1>
                    <p className='lg:text-xl  text-sm font-medium font-inter-tight text-center'>
                    ...
                    <ul className='list-none mt-4 w-full space-y-5'>
                        {list.map((item, index) => (
                            <li key={index} className='flex items-center '>
                                ...
                                <span className='lg:text-xl text-xs font-inter-tight font-regular text-[#646464]'>{item.description}</span>
                            </li>
                        ))}
                    </ul>
                </div>
