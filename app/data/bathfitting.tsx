import image10 from '@/assets/product/bathfitting/bathfitting-1.png'
import image11 from '@/assets/product/bathfitting/bathfitting-2.png'
import image12 from '@/assets/product/bathfitting/bathfitting-3.png'
import image13 from '@/assets/product/bathfitting/bathfitting-4.png'
import image14 from '@/assets/product/bathfitting/bathfitting-5.png'
import image15 from '@/assets/product/bathfitting/bathfitting-6.png'
export const bathfitting = [
  {
    heading: '',
    products: [
      {
      ...
      },
      {
        ...
        specs: [
          "Material: Premium UPVC Body & Brass Thread",
          "Mechanism: Highly Efficient Spring-Loaded Non-Return",
          "Inlet Size: Standard Pump Suction Fitting",
          "Build Quality: 100% Leak-Proof & Anti-Corrosive",
          "Strength: High-Density Crack-Resistant Polymer",
          "Suitable For: Borewells, Openwells, Pump Suction Systems",
          "Installation: Standard Thread Connection",
          "Warranty: 5-Year Replacement Guarantee"
        ]
      },
      {
        ...
        specs: [
          "Material: Premium Stainless Steel Braided Outer & Brass Fittings",
          "Mechanism: Flexible Connection Hose",
          "Inlet Size: ½\" Standard Fitting",
          "Build Quality: 100% Leak-Proof, Rust-Resistant & High-Pressure Bearing",
          "Strength: Double-Lock Braided Steel",
          "Suitable For: Geysers, Water Heaters, Wash Basin Connections",
          "Installation: Easily Fits Standard Inlets",
          "Warranty: 5-Year Replacement Guarantee"
        ]
      }
    ]
