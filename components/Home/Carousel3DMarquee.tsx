...
const Carousel3DMarquee: React.FC<RollingGalleryProps> = ({
  ...
  return (
    <div className="overflow-x-hidden">
      <motion.div
        className="relative h-[85dvh] md:min-h-[850px] md:h-[65dvh] lg:h-[80dvh] xl:h-[85dvh] w-full overflow-hidden flex flex-col justify-center md:block sm:py-10 lg:py-20"
      ...
      >
        ...
        <div className="flex grow md:h-full items-center justify-center [perspective:2500px] [transform-style:preserve-3d] translate-y-[-10%] md:translate-y-[-5%]">
          <motion.div
            drag="x"
            dragElastic={0}
            dragMomentum={false}
