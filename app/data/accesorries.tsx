import image21 from '@/assets/product/accessories/accessories-1.png'
...
export const accessories = [
  {
    ...
    products: [
      ...
      },
      {
        ...
        specs: [
          "Material: Heavy-Duty Reinforced Polymer Composite",
          "Mechanism: Dual Flush Water-Saving Valve",
          "Build Quality: Weather, UV & Temperature Resistant",
          "Strength: High Impact & Crack Resistant",
          "Suitable For: Residential & Commercial Bathrooms",
          "Maintenance: Easy Lift & Access Design",
          "Warranty: 5-Year Replacement Guarantee"
        ]
      },
      {
        ...
        specs: [
          "Material: Heavy-Duty GFRP (Glass Fiber Reinforced Polymer)",
          "Design: Secure, Anti-Skid & Lockable Cover",
          "Build Quality: Weather, UV & Temperature Resistant",
          "Strength: High Load Bearing Capacity with GFRP Rods",
          "Suitable For: Underground Chambers, Drainage Systems, Water Tanks",
          "Maintenance: Easy Lift & Access Design",
          "Durability: Non-Brittle & Long-Lasting",
          "Warranty: 5-Year Replacement Guarantee"
        ]
      ...
      },
      {
        ...
        specs: [
          ...
          "Maintenance: Anti-Clogging Easy Clean Nozzles",
          "Installation: Standard Overhead Connection",
          "Warranty: 5-Year Full Replacement Guarantee"
        ]
      },
      {
        ...
        specs: [
          "Material: Premium Quality High-Grade Polymer / Metal Braiding",
          "Build Quality: Durable, Leak-Proof & Long-Lasting",
          "Performance: Precision Engineered for Efficiency",
          "Strength: High Impact & Crack Resistant",
          "Application: Geyser, Basin & Toilet Connections",
          "Maintenance: Low Maintenance & Easy to Clean",
          "Installation: Standard Industry Fitting Compatible",
          "Warranty: 5-Year Full Replacement Guarantee"
        ]
