    ...
    return (
        <ContainerLayout>
            ...
            <div className='flex flex-col items-center'>
                <h1 className='font-medium text-xl md:text-[44px] tracking-[-4%] font-hoves-pro'>Insights That Inspire</h1>
                <p className='font-regular text-sm text-center md:text-xl font-inter-tight'>
                    Stay updated on the latest in piping materials, systems, techniques, and industry standards.
                </p>
            </div>
                    ...
                    return (
                        <div key={index} className={`relative w-full overflow-hidden rounded-[20px] shadow-lg ${gridClass}`}>
                            ...
                            <div className="absolute inset-0 flex flex-col justify-end p-6 z-10">
                                <h2 className="text-white text-xl md:text-[28px] leading-[24px] md:leading-[30px] font-hoves-pro font-medium mb-1 uppercase text-left">{item.title}</h2>
                                <div className="flex items-center gap-2 text-white/90 cursor-pointer hover:text-white transition-colors">
                                    <span className="text-sm font-inter-tight font-medium">Read the Article</span>
